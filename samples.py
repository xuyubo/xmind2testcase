...
def main():
    ...
    print(f'Convert XMind file to zentao csv file successfully: {zentao_csv_file}')
    # (2) testlink
    testlink_xml_file = xmind_to_testlink_xml_file(xmind_file)
    print(
        f'Convert XMind file to testlink xml file successfully: {testlink_xml_file}'
    )
    ...
    print(
        f'Convert XMind file to testsuite json file successfully: {testsuite_json_file}'
    )

    # (2) testcase
    testcase_json_file = xmind_testcase_to_json_file(xmind_file)
    print(
        f'Convert XMind file to testcase json file successfully: {testcase_json_file}'
    )
